...
**
** Created: Tue Oct 12 17:16:32 2010
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        repoTreeView = new QTreeView(tab_2);
        repoTreeView->setObjectName(QString::fromUtf8("repoTreeView"));
        repoTreeView->setAlternatingRowColors(true);
        repoTreeView->setRootIsDecorated(false);
        repoTreeView->setItemsExpandable(false);
        repoTreeView->setSortingEnabled(true);

        verticalLayout_3->addWidget(repoTreeView);
