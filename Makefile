...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Wed May 12 14:10:15 2010
# Project:  dudley.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/dudley1.0.0/ && $(COPY_FILE) --parents fileinfo.h filerepostate.h filerepostatelogger.h filerepo.h workingfilerepo.h storagefilerepo.h output.h transferqueue.h .tmp/dudley1.0.0/ && $(COPY_FILE) --parents main.cpp fileinfo.cpp filerepostate.cpp filerepostatelogger.cpp filerepo.cpp workingfilerepo.cpp storagefilerepo.cpp output.cpp transferqueue.cpp .tmp/dudley1.0.0/ && (cd `dirname .tmp/dudley1.0.0` && $(TAR) dudley1.0.0.tar dudley1.0.0 && $(COMPRESS) dudley1.0.0.tar) && $(MOVE) `dirname .tmp/dudley1.0.0`/dudley1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/dudley1.0.0
