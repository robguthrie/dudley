...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Mar 29 20:53:38 2010
# Project:  dudley.pro
# Template: app
...
INCPATH       = -I../../qtsdk-2010.02/qt/mkspecs/linux-g++-64 -I. -I../../qtsdk-2010.02/qt/include/QtCore -I../../qtsdk-2010.02/qt/include -I.
LINK          = g++
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/dudley1.0.0/ && $(COPY_FILE) --parents fileinfocollection.h fileinfo.h logger.h storagecollection.h .tmp/dudley1.0.0/ && $(COPY_FILE) --parents main.cpp fileinfocollection.cpp fileinfo.cpp logger.cpp storagecollection.cpp .tmp/dudley1.0.0/ && (cd `dirname .tmp/dudley1.0.0` && $(TAR) dudley1.0.0.tar dudley1.0.0 && $(COMPRESS) dudley1.0.0.tar) && $(MOVE) `dirname .tmp/dudley1.0.0`/dudley1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/dudley1.0.0
...
main.o: main.cpp fileinfocollection.h \
		fileinfo.h \
		logger.h
...
logger.o: logger.cpp logger.h \
		fileinfo.h \
		fileinfocollection.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o logger.o logger.cpp

storagecollection.o: storagecollection.cpp storagecollection.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o storagecollection.o storagecollection.cpp
